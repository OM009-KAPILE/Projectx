      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">
            Enter your university email and we will send you a password reset code
          </p>
        </div>
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-5">
          ...
          {isSent ? (
            <div className="space-y-4 text-center">
              <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 space-y-2 text-left">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">
                  If an account exists with <strong className="text-white">{email}</strong>, you will receive an email with your 6-digit password reset code.
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isLoading ? 'Sending Reset Instructions...' : 'Send Password Reset Code'}
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </form>
          )}
